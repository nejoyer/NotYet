...
public class SwipeLayout extends FrameLayout {
    ...
    void layoutPullOut() {
        ...
        if(surfaceRect == null) {
            surfaceRect = computeSurfaceLayoutArea(getOpenStatus() == Status.Open);
        }
        if (surfaceView != null) {
    ...
    public void close(boolean smooth, boolean notify) {
        //invalidate the cache, otherwise the open positions will be used resulting in incorrect display (unless you use smooth).
        if(!smooth) {
