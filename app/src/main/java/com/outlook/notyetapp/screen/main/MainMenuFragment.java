...
import com.outlook.notyetapp.AboutActivity;
import com.outlook.notyetapp.BuildConfig;
import com.outlook.notyetapp.HelpActivity;
import com.outlook.notyetapp.R;
import com.outlook.notyetapp.SettingsActivity;
import com.outlook.notyetapp.SortActivity;
...
public class MainMenuFragment extends Fragment {
    ...
    public static MainMenuFragment newInstance(boolean showAll) {
        ...
        args.putBoolean(SharedPreferencesManager.SHOW_ALL_KEY, showAll);
        fragment.setArguments(args);
        return fragment;
    }

    public void loadMemberVariablesFromBundle(Bundle bundle){
        mShowAll = bundle.getBoolean(SharedPreferencesManager.SHOW_ALL_KEY);
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        outState.putBoolean(SharedPreferencesManager.SHOW_ALL_KEY, mShowAll);
    ...
    public void setVisiblityIcon()
    {
        ...
        if(mShowAll)
        {
            ...
            mVisibilityChangedMenuItem.setTitle(R.string.action_visibility_on_label);
        }
        else {
            mVisibilityChangedMenuItem.setIcon(R.drawable.ic_visibility_black_24dp);
            mVisibilityChangedMenuItem.setTitle(R.string.action_visibility_off_label);
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_visibility_changed:
                mShowAll = !mShowAll;
                if(BuildConfig.FLAVOR.equals("demo")){
                    // Easter Egg in the demo flavor.
                    // Tap the eye icon 6 times to get a "reset demo" menu item.
