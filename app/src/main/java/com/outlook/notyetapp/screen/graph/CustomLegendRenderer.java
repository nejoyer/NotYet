...
// A complete rip of the code from LegendRenderer, but with a tiny portion to
// allow the ability for the user to tap the legend to toggle the visibility of that series.
