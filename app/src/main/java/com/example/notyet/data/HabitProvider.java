...
public class HabitProvider extends ContentProvider {
    ...
    private static UriMatcher buildUriMatcher(){
        ...
        // URI content://com.example.notyet.app/activities/#
        ...
        // URI content://com.example.notyet.app/activities/#/stats
        ...
        // URI content://com.example.notyet.app/activities/mostrecent
        ...
        // URI content://com.example.notyet.app/habitdata/#
        ...
        // URI content://com.example.notyet.app/activities/#/habitdata
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (sUriMatcher.match(uri)) {
            // content://com.example.notyet.app/activities/#
            case HabitContract.ACTIVITY:
            {
            ...
            // content://com.example.notyet.app/activities/stats
            case HabitContract.ACTIVITIES_TODAYS_STATS:
            {
            ...
            // content://com.example.notyet.app/activities/mostrecent
            case HabitContract.ACTIVITIES_MOST_RECENT: {
            ...
            // content://com.example.notyet.app/habitdata/#
            //case HabitContract.HABITDATA_ENTRY: {
            //    break;
            //}
            // content://com.example.notyet.app/activities/#/stats
            ...
            // content://com.example.notyet.app/activities/#/habitdata
            case HabitContract.ACTIVITY_HABITDATA_ENTRIES: {
    ...
    public int update(Uri uri, ContentValues contentValues, String selection, String[] selectionArgs) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            //content://com.example.notyet/activities/#/habitdata
            case HabitContract.ACTIVITY_HABITDATA_ENTRIES:
            {
                long activityNumber = HabitContract.ActivitiesEntry.getActivityNumberFromUri(uri);
